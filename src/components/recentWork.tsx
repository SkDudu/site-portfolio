            ...
            <div className='grid grid-row gap-4 mt-8 mx-auto max-w-7xl px-4'>
                <div className="flex flex-col h-auto bg-white rounded shadow-lg md:flex-row 1">
                    ...
                    <div className="flex flex-col p-4 leading-normal text-left">
                        ...
                        <div>
                        <a href ="" className="flex flex-column md:w-[190px] items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-[#14213D] bg-gray-100 hover:bg-[#E0E6F5] hover:text-bg-[#1E315C] md:py-4 md:text-lg md:px-10">Ver mais </a>   
                        </div>
                    </div>
                </div>
            </div>
