...
export default function Modal() {
  ...
  return (
    <>
      <button
        className="w-full flex items-center justify-center px-8 py-3 md:text-base text-sm font-medium rounded-md text-white bg-[#14213D] hover:bg-[#1E315C] focus:ring-4 focus:outline-none focus:ring-amber-300"
        type="button"
      ...
      {showModal ? (
        <>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
              <div className="opacity-40 fixed inset-0 z-10 bg-black"></div>
              <div className="flex justify-center items-center fixed z-20 overflow-x-hidden overflow-y-auto inset-2 outline-none focus:outline-none">
                <div className="flex justify-center my-auto max-w-3xl">
                  {/*content*/}
                    ...
                    <div className="relative p-6 flex-auto">
                        ...
                        <div>
                          ...
                          <div className="relative mb-6">
                            ...
                            <input type={"text"} placeholder="Seu nome" name='user_name' required className="bg-gray-50 border border-gray-300 pl-10 text-gray-900 text-sm rounded outline-none focus:ring block w-full p-2.5"/>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative mb-6">
                            ...
                            <input type={"email"} id="input-group-1" name="user_email" required className="bg-gray-50 border border-gray-300 text-gray-900 pl-10 text-sm rounded outline-none focus:ring block w-full p-2.5" placeholder="nome@email.com"/>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative mb-6">
                            ...
                            <input type={"tel"} placeholder="(00) 0 0000-0000" name="user_phone" required className="bg-gray-50 border border-gray-300 pl-10 text-gray-900 text-sm rounded outline-none focus:ring block w-full p-2.5"/>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative mb-6">
                            ...
                            <textarea rows={4} name="user_porjdescription" required className="block p-2.5 w-full text-sm pl-10 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 outline-none focus:ring" placeholder="Conte um pouco mais sobre o seu projeto..."></textarea>
                          </div>
                        </div> 
                        ...
                        <ul className="grid gap-3 w-full md:grid-cols-3">
                            <li>
                                <input type="checkbox" id="webdesign-option" value="" name="user_projtype" className="hidden peer" required={true}/>
