...
export default function Footer(){
    return(
        <footer className="p-4 bg-white sm:p-6 mt-10 mx-auto max-w-7xl">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="#" className="flex items-center">
                        <img src={logo_personal} className="mr-3 h-8" alt="FlowBite Logo"/>
                        <span className="self-center text-2xl font-semibold whitespace-nowrap text-black">Eduardo Santos</span>
                    </a>
                </div>
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="#" className="text-gray-500 hover:text-[#14213D]">
                        ...
                        <a href="https://github.com/SkDudu" className="text-gray-500 hover:text-[#14213D]">
                        ...
                        <a href="https://dribbble.com/DudsSantos" className="text-gray-500 hover:text-[#14213D]">
                        ...
                        <a href="https://www.behance.net/dudusantoss" className="text-gray-500 hover:text-[#14213D]">
                            <BehanceLogo size={20}/>
                        </a>
                    </div>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://www.linkedin.com/in/dudusantos/" className="hover:underline">Eduardo Santos</a>. Todos os direitos reservados.</span>
            </div>
        </footer>
    )
}